...
def Build_Correctives(side='L'):
    ...
    mus_corrective_dict = {
    f"legpiston_{SideShort}_01": {
        "mus_root": f"{SideLong}LegPiston01",
        "mus_end": f"{SideLong}LegPiston02",
        "tgt_limb": f"Leg_{SideShort}_02_bindJNT_seg_03_JNT",
        "tgt_limb_twist":'Y',
        "tgt_limb_pop":'X',
        "tgt_limb_stretch":'Z',
        "tgt_extra":None,
        "par_jnt":f"Leg_{SideShort}_01_bindJNT_seg_02_JNT",
        "tgt_name":f'legpiston_{SideShort}_insert01',
        "pop_mult":0,
        "slide_mult":0,
        "segments":1,
        "match_index":None,
    ...
    f"legpiston_{SideShort}_02": {
        "mus_root": f"{SideLong}LegPiston03",
        "mus_end": f"{SideLong}LegPiston04",
        "tgt_limb": f"Leg_{SideShort}_03_bindJNT_seg_02_JNT",
        "tgt_limb_twist":'Y',
        "tgt_limb_pop":'X',
        "tgt_limb_stretch":'Z',
        "tgt_extra":None,
        "par_jnt":f"Leg_{SideShort}_02_bindJNT_seg_03_JNT",
        "tgt_name":f'legpiston_{SideShort}_insert02',
        "pop_mult":0,
        "slide_mult":0,
        "segments":1,
        "match_index":None,
