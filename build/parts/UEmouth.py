...
class UEmouth(UEface):
    ...
    def build(self):
        ...
        if self.spline == True:
            # -------------------------------
            # Step 1 - Build Major Controls
            # -------------------------------
            major_ctrl_groups = {}

            upper_major_drivers = [f'Major_{prefix}_L_CornerLip_JNT', f'Major_{prefix}_L_UpperLip_0{self.Major_Mouth}_JNT', f'Major_{prefix}_M_UpperLip_01_JNT', f'Major_{prefix}_R_UpperLip_0{self.Major_Mouth}_JNT', f'Major_{prefix}_R_CornerLip_JNT' ]
            lower_major_drivers = [f'Major_{prefix}_L_CornerLip_JNT', f'Major_{prefix}_L_LowerLip_0{self.Major_Mouth}_JNT', f'Major_{prefix}_M_LowerLip_01_JNT', f'Major_{prefix}_R_LowerLip_0{self.Major_Mouth}_JNT', f'Major_{prefix}_R_CornerLip_JNT' ]
            #major_list = upper_lip + lower_lip  # Assuming major controls exist in these guides
            ...
            for loc in MajorList:
                ...
                ctrl_grp = f"Major_{loc}_Mouth_CTRL_CNST_GRP"
                major_ctrl_groups[loc] = ctrl_grp
            ...
            # -------------------------------
            # Step 4 - Minor Controls + Joints
            # -------------------------------
            rib_offsets = []

            # Upper Lip Minor Controls
            upperdriven = []
            lowerdriven = []
            rib_offsets = []
            ...
            upper_spline = matrix_spline_from_transforms(
                ...
                name=f"{prefix}_UpperLip",
                create_curve=True
            )

            lower_spline = matrix_spline_from_transforms(
                transforms=lower_major_drivers,
                transforms_to_pin=lowerdriven,
                name=f"{prefix}_LowerLip",
                create_curve=True
            )


            mc.group( *rib_offsets, 'Major_Mouth_M_UpperLip_01_JNT', 'Major_Mouth_M_LowerLip_01_JNT', f'Major_Mouth_L_UpperLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_L_LowerLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_R_UpperLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_R_LowerLip_0{self.Major_Mouth}_JNT', 'Major_Mouth_L_CornerLip_JNT', 'Major_Mouth_R_CornerLip_JNT', name='Mouth_Extras_offsets')
            if self.Major_2:
            ...
            mc.hide( 'Major_Mouth_M_UpperLip_01_JNT', 'Major_Mouth_M_LowerLip_01_JNT', f'Major_Mouth_L_UpperLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_L_LowerLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_R_UpperLip_0{self.Major_Mouth}_JNT', f'Major_Mouth_R_LowerLip_0{self.Major_Mouth}_JNT', 'Major_Mouth_L_CornerLip_JNT', 'Major_Mouth_R_CornerLip_JNT',)
            if self.Major_2:
