...
def build_simple_muscle_chain(
    ...
    mc.addAttr(root_jnt, longName='AutoRot', at='double', dv=-0, k=True)
...
def Build_Piston(side='L'):
    ...
    f"legpiston_{SideShort}_01": {
        "mus_root": "Leg_piston_up", 
        "mus_end": "Leg_piston_low",
        "tgt_limb": f'Foot_{SideShort}_MusTgt_GRP',
        "tgt_limb_twist":'Y',
        "tgt_limb_pop":'X',
        "tgt_limb_stretch":'Z',
        "tgt_extra":None,
