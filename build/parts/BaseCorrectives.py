...
def pop_corrective(
    ...
    rot = mc.xform(pop_root, query=True, worldSpace=True, rotation=True)
...
def build_simple_muscle_chain(
    ...
    flip_pop=False,
    aimpos=(0,400,0),
    realtgt = None, #'Foot_{self.side}_MusTgt_GRP'
    rig_module=None
):
    created_joints = []
    created_groups = []
...
def Build_Correctives(side='L'):
    ...
    f"Tibialis_{SideShort}_02": {
        "mus_root": f"{SideLong}_Tibialis01",
    ...
    f"Purlicue_{SideShort}_01": {
        "mus_root": f"{SideLong}_Purlicue_01",
        "mus_end": f"{SideLong}_Purlicue_Insert",
        "tgt_limb": f'fingerThumb_{SideShort}_01_JNT', #f'foot_{SideShort}_01_JNT',
        "tgt_limb_twist":'Y',
        "tgt_limb_pop":'X',
        "tgt_limb_stretch":'Z',
        "tgt_extra":None,
        "par_jnt":f'fingerIndex_{SideShort}_01_JNT',
        "tgt_name":f'Purlicue_{SideShort}_insert',
        "pop_mult":0,
        "slide_mult":0,
        "segments":1,
        "match_index":None,
    ...
    f"HipBone_{SideShort}_01": {
        "pop_root" : f'{SideLong}UpLeg',
        "par_jnt" : f'COG_M_JNT',
        "pop_descriptor" : f'{SideShort}_HipBone',
        "tgt_limb" : f'leg_{SideShort}_01_JNT',
        "blend_par" : [],
        "pop_mult" : .2 * mod,
        "tgt_limb_pop" : 'X',
    ...
    f"Bicep_{SideShort}_02": {
        "pop_root" : f'{SideLong}ForeArm',
        "par_jnt" : f'arm_{SideShort}_04_JNT',
        "pop_descriptor" : f'{SideShort}_Bicep02',
        "tgt_limb" : f'arm_{SideShort}_05_JNT',
        "blend_par" : [],
        "pop_mult" : .3 * mod,
        "tgt_limb_pop" : 'X',
    ...
    f"Bicep_{SideShort}_03": {
        "pop_root" : f'{SideLong}ForeArm',
        "par_jnt" : f'arm_{SideShort}_05_JNT',
        "pop_descriptor" : f'{SideShort}_Bicep03',
        "tgt_limb" : f'arm_{SideShort}_05_JNT',
        "blend_par" : [],
        "pop_mult" : -.2 * mod,
        "tgt_limb_pop" : 'X',
    ...
    f"Bicep_{SideShort}_05": {
        "pop_root" : f'{SideLong}ForeArm',
        "par_jnt" : f'arm_{SideShort}_05_JNT',
        "pop_descriptor" : f'{SideShort}_Bicep05',
        "tgt_limb" : f'arm_{SideShort}_05_JNT',
        "blend_par" : [],
        "pop_mult" : .2 * mod,
        "tgt_limb_pop" : 'X',
    ...
    f"LowThigh_{SideShort}_01": {
        "pop_root" : f'{SideLong}Leg',
        "par_jnt" : f'leg_{SideShort}_04_JNT',
        "pop_descriptor" : f'{SideShort}_LowThigh01',
        "tgt_limb" : f'leg_{SideShort}_05_JNT',
        "blend_par" : [],
        "pop_mult" : .1 * mod,
        "tgt_limb_pop" : 'X',
    ...
    f"IndexIn_{SideShort}_03": {
        ...
        "par_jnt" : f'fingerIndex_{SideShort}_04_JNT',
    ...
    f"MiddleIn_{SideShort}_03": {
        ...
        "par_jnt" : f'fingerMiddle_{SideShort}_04_JNT',
    ...
    f"RingIn_{SideShort}_03": {
        ...
        "par_jnt" : f'fingerRing_{SideShort}_04_JNT',
    ...
    f"PinkyIn_{SideShort}_03": {
        ...
        "par_jnt" : f'fingerPinky_{SideShort}_04_JNT',
    ...
    f"ThumbIn_{SideShort}_02": {
        "pop_root" : f'{SideLong}HandThumb2',
        "par_jnt" : f'fingerThumb_{SideShort}_01_JNT',
        "pop_descriptor" : f'{SideShort}_ThumbIn02',
        "tgt_limb" : f'fingerThumb_{SideShort}_02_JNT',
        "blend_par" : [],
        "pop_mult" : -.05 * mod,
        "tgt_limb_pop" : 'Z',
        "pop" : 'X',
    ...
    f"ThumbIn_{SideShort}_03": {
        "pop_root" : f'{SideLong}HandThumb3',
        "par_jnt" : f'fingerThumb_{SideShort}_02_JNT',
        "pop_descriptor" : f'{SideShort}_ThumbIn03',
        "tgt_limb" : f'fingerThumb_{SideShort}_03_JNT',
        "blend_par" : [],
        "pop_mult" : -.05 * mod,
        "tgt_limb_pop" : 'Z',
        "pop" : 'X',
    ...
    f"ThumbOut_{SideShort}_03": {
        "pop_root" : f'{SideLong}HandThumb2',
        "par_jnt" : f'fingerThumb_{SideShort}_02_JNT',
        "pop_descriptor" : f'{SideShort}_ThumbOut03',
        "tgt_limb" : f'fingerThumb_{SideShort}_03_JNT',
        "blend_par" : [],
        "pop_mult" : -.05 * mod,
        "tgt_limb_pop" : 'Z',
