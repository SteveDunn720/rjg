...
PART_CONFIG = {
    ...
    "trap04": {
        "Axes": ["Y", "Z", "X"],
        "Names": ["Left_Trap04", "Left_Trap_insert04"],
        "Delete_Last": False,
        "Guide_Type": 'Joint',
        "BuildParent":False,
        "Bake_To_Orient":False,
